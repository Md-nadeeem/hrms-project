...
const Resources = () => {
    ...
    <Col span={5} key={item.id} style={{ boxShadow: "0px 0px 5px 1px rgba(0 , 0, 0, 0.2)", borderRadius: '5px' }}>
        <Card className='w-full flex justify-center' bordered={false} style={{ boxShadow: 'none' }}>
